...
import 'package:flutter_gail/feature/hpoil_dashboard/presentation/page/hpOil_dashboard_page.dart';
...
class HomeHelper {
  ...
  static Future<dynamic> fetchPageList() async {
    ...
    //   for (var permissionData in taskModule.permissions!) {
